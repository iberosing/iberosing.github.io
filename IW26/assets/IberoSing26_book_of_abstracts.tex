...
\begin{itemize}[leftmargin=*]
    \item \textbf{Tuesday, June 30:} \emph{Zariski site as a precohesive topos} --- Lidia Angélica Ávila Déciga.
    \item \textbf{Tuesday, June 30:} \emph{Real algebraic realization of divide links} --- Arthur Garcia Tonus.
    \item \textbf{Tuesday, June 30:} \emph{Holomorphic mappings and their frontalisations} --- Christian Muñoz Cabello.
    \item \textbf{Tuesday, June 30:} \emph{Jets of good real images} --- Ignacio Breva Ribes.
    \item \textbf{Tuesday, June 30:} \emph{The Singular Derived Category of a Hypersurface} --- Jesús Javier Vidales Pérez.
    \item \textbf{Tuesday, June 30:} \emph{Essential divisors and the higher Nash modification for RDP singularities} --- José Alejandro Tenorio Vázquez.
    \item \textbf{Thursday, July 2:} \emph{Higher-order connections for modules} --- Jesús Daniel Aparicio Barrera.
    \item \textbf{Thursday, July 2:} \emph{Cubical hyperresolutions for stable corank $\leq 1$ maps} --- José Galindo Jiménez.
    \item \textbf{Thursday, July 2:} \emph{Line arrangements on Cubic Surfaces} --- Juan Carlos Castro Rivera.
    \item \textbf{Thursday, July 2:} \emph{The Link of Polar Weighted Homogeneous Polynomials} --- Jessica Torres Flores.
    \item \textbf{Thursday, July 2:} \emph{On the isotropic points of holomorphic curves} --- Amanda Dias Falqueto.
\end{itemize}
